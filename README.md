...
"403" error just means that youtube is blocking the downloads, however BatchSD tries to deal with this by skipping that video and remembering to come back to download it. 
